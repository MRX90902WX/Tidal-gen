...
system("clear")
print("")
print("\033[1;33mT\033[1;34m--------------------------------------------------\033[1;31mT")
print("\033[1;36m")
system("cat y.txt")
print("")
print("\033[1;33mT\033[1;34m----------------------------------------------------\033[1;31mT")
print("")
print("              \033[1;31m --------------------")
print("              \033[1;31m|   \033[1;32mIP: \033[1;36m   USA       \033[1;31m|")
...
print("")
volver = input("\033[1;37mDesea volver a generar [yes/no]: ")

if volver == "yes":
    system("python Tidal-gen.py")
else:
    exit()
